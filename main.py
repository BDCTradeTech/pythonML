...
from tabs.descuentos import build_tab_descuentos
...
from tabs.publicidad import build_tab_publicidad
...
ML_MENU_GROUPS = [
    ...
    ("CATÁLOGO", [
        ...
        ("DESCUENTOS", "Descuentos", "descuentos", "percent", "BETA"),
    ...
    with container:
        ...
        with ui.element("div").classes("hidden"):
            with ui.tabs() as tabs:
                ...
                tab_descuentos = ui.tab("Descuentos")
                ...
                tab_publicidad = ui.tab("Publicidad")
        ...
        def _lazy_load(val: str) -> None:
            ...
            elif val == "Descuentos" and not descuentos_cargado[0]:
                descuentos_cargado[0] = True
                build_tab_descuentos(descuentos_container)
            ...
            elif val == "Publicidad" and not publicidad_cargado[0]:
                publicidad_cargado[0] = True
                build_tab_publicidad(publicidad_container)
        ...
        with ui.row().classes("w-full items-center q-pa-md bg-grey-2 gap-2 flex-wrap"):
            with ui.row().classes("items-center gap-1 flex-wrap"):
                ...
                ml_subs = [("DASHBOARD", "Dashboard", "dashboard"), ("ESTADÍSTICAS", "Estadísticas", "estadisticas"), ("VENTAS", "Ventas", "ventas"), ("PRODUCTOS", "Productos", "productos"), ("SALUD", "Salud", "salud"), ("DESCUENTOS", "Descuentos", "descuentos"), ("CUOTAS", "Cuotas", "cuotas"), ("PROMOS", "Promos", "promos"), ("STOCK", "Stock", "stock"), ("COMPETIDORES", "Competidores", "competidores"), ("PUBLICIDAD", "Publicidad", "publicidad"), ("PREGUNTAS", "Preguntas", "preguntas"), ("FLEX", "Flex", "flex"), ("BÚSQUEDA", "Búsqueda", "busqueda"), ("BALANCE", "Balance", "balance")]
        ...
        with tab_panels:
            ...
            with ui.tab_panel(tab_descuentos):
                descuentos_container = ui.column().classes("w-full")
            ...
            with ui.tab_panel(tab_publicidad):
                publicidad_container = ui.column().classes("w-full")
