...
TAB_REGISTRY: List[Tuple[str, str, str]] = [
    ...
    ("TiendaNube", "tn_diferencias", "Diferencias"),
    ("Admin", "admin", "Admin"),
...
TAB_DESCRIPTIONS: Dict[str, str] = {
    ...
    "tn_diferencias": "SKUs en ambas plataformas: precio objetivo vs. actual y stock ML vs. TN, solo lectura.",
}
