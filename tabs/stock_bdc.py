"""
Fase 3 — tabs/stock_bdc.py
Pestaña Stock BDC: inventario de QuickBooks (Items con QtyOnHand > 0).
Funciones exportadas: build_tab_stock_bdc
"""
...
def build_tab_stock_bdc(container) -> None:
    """Pestaña Stock BDC: inventario de QuickBooks (Items con QtyOnHand > 0)."""
    user = _require_login()
    if not user:
        return
